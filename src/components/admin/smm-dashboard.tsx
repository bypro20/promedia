...
type Tab = 'panels' | 'mapping' | 'profit'
    ...
    <main className="p-4 lg:p-8">
      ...
      {!data.configured && (
        <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
          Demo mod aktif — en az bir panel API key girin. MedyaBayim veya TurkiyeResellers ile başlayın (min. ₺50).
        </div>
      )}
            ...
            <div key={p.id} className="rounded-2xl bg-white p-5 shadow-sm">
              ...
              <div className="mt-3 flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-xl border px-3 py-2 text-sm outline-none focus:border-[#7844E4]"
                />
                <button
                  type="button"
      ...
      {tab === 'profit' && markup && (
        <div className="mt-6 max-w-lg space-y-4 rounded-2xl bg-white p-6 shadow-sm">
          ...
          <label className="flex items-center gap-2 text-sm">
            ...
            Türk panelleri tercih et (MedyaBayim vb.)
          </label>
